...
(function($) {
    ...
    wpmfFoldersFiltersModule =  {
        ...
        initDropdown : function($current_frame){
            ...
            if ($('.wpmf-filters-dropdown ul li ul li:not(:first-child) .check').length
                || $('.own-user-media .check').length
                || $('.display-all-media .check').length
                || wpmfFoldersFiltersModule.wpmf_all_media) {
        ...
        displayAllMedia : function(filter_elem, all_folder = 0) {
